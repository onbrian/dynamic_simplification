...
// cped from E3 Analytics code
declare namespace CanvasJS
{
    /***********
        Added some custom interfaces and classes for custom E3 CanvasJS Typings
        that were contained in other files
    ************/
    interface IKeyVaueNumber<T>
    {
        Key: number;
        Value: T;
    }
    ...
    /***********
        changed by brian:
        - added RangeChangeEvent, RangeChangeAxisData interfaces
        - changed type of rangeChanged, rangeChanging attribute in ChartOptions interface

        NOTE:
        - upon inspection, it seems like there is a CanvasJS.ChartEvent, a more general event 
        that may remove the necessity for my added RangeEvents. Be sure to check them out.
    ...
    */
    ...
    interface ChartOptions {
        ...
        // altered by brian
        rangeChanging?: (e: RangeChangeEvent) => void;
        // altered by brian
        rangeChanged?: (e: RangeChangeEvent) => void;
        dataPointMaxWidth?: number;
        subtitles?: Array<ChartTitleOptions>;
        creditText?: string;
        IsStatusBasedMarkers?: boolean;

        E3DataId?: string;
        E3ChartAreaName?: string;
        ChartSettingsIndex?: number;
        E3ChartLocation?: string;
        E3ColorByLegends?: Object;
        isfullscreenMode?: boolean;
        actionItems?: Array<{ Name: string; Callback: Function; }>;
        customDropdownItems?: Array<{ Name: string; Callback: Function; }>;
        marginRight?: number;
        E3XaxisStringValues?: Array<IKeyVaueNumber<string>>;
        E3YaxisStringValues?: Array<IKeyVaueNumber<string>>;
        E3YaxisStringValues_R?: Array<IKeyVaueNumber<string>>;
        IsMarkerEnabled?: boolean;
        MarkerColorLegends?: Array<Group>;
        MarkerStyleLegends?: Array<Group>;
        e3xAxisType?: XAxisType;
        summary?: string;
        /**
    ...
    interface ChartLegendStyleOptions {
        fontSize?: string;
        color?: string;
        fontWeight?: string;
        width?: string;
    ...
    interface ChartLegendOptions {
        ...
        itemStyle?: ChartLegendStyleOptions;
        itemHoverStyle?: ChartLegendStyleOptions;
        itemHiddenStyle?: ChartLegendStyleOptions;
        itemCheckboxStyle?: ChartLegendStyleOptions;
        /**
    ...
    interface ChartEvent {
        trigger?: string;
        axisX?: Array<ChartAxisXOptions>;
        axisY?: Array<ChartAxisYOptions>;
        axisY2?: Array<ChartAxisYOptions>;
        /**
    ...
    interface RangeChangeAxisData {
        viewportMinimum: number;
        viewportMaximum: number;
    }

    interface RangeChangeEvent {
        // event type -- "rangeChanging" or "rangeChanged"
        type: string;
        // "zoom", "pan", or "reset"
        trigger: string;
        chart: Chart;
        // returned only if axisX is present
        axisX?: Array<RangeChangeAxisData>;
        // returned only if axisY is present
        axisY?: Array<RangeChangeAxisData>;
        // returned only if axisX2 is present
        axisX2?: Array<RangeChangeAxisData>;
        // returned only if axisY2 is present
        axisY2?: Array<RangeChangeAxisData>;
    ...
    interface ChartAxisOptions {
        ...
        XaxisToCategoryStringValues?: Array<string>;
        titleClick?: Function;
        /**
        * Sets the Axis Title.
        * Default: null
        ...
        */
        stripLines?: Array<ChartStripLines>;
    }
